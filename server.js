...
if (!process.env.ADMIN_PASSWORD) {
  console.warn(
    "WARNING: ADMIN_PASSWORD no está configurada; se está usando el valor predeterminado."
  );
}
...
//
// IMPORTANTE:
// No usar app.get("*") porque causa el error
